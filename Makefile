...
verify:
	sh -n build.sh opt/bin/main/upgrade opt/bin/monitor/bypass_check.sh opt/bin/monitor/block_watch.sh opt/bin/monitor/www/cgi-bin/manage.sh opt/bin/monitor/www/cgi-bin/data.sh
